...
export default function UserDashboard() {
    ...
    return (
        <div className="px-20 py-10 bg-white min-h-screen transition-colors duration-300">
            ...
            {modalOpen && (
                <div tabIndex={-1} aria-hidden={!modalOpen} className="fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full md:inset-0 h-[100vh] max-h-full bg-black/50 bg-opacity-40">
